...
import com.example.demospringbatch.listeners.JobListener;
...
public class BatchConfiguration {
    ...
    public FlatFileItemReader<Person> reader() {
        return new FlatFileItemReaderBuilder<Person>()
                ...
                .delimited()
                .names(new String[] {"firstName", "surname", "email", "phone", "age"})
    ...
    public JdbcBatchItemWriter<Person> writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<Person>()
                ...
                .sql("INSERT INTO person (firstName, surname, email, phone, age) VALUES (:firstName, :surname, :email, :phone, :age)")
